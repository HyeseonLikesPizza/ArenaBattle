...
AABCharacter::AABCharacter()
{
	...
	*/
	...
	// ArenaBattleSetting 모듈의 ini에서 지정한 애셋의 목록 정보를 얻어온다
	...
	// 캐릭터 스테이트
	// 플레이어가 캐릭터를 조종하는 경우에는 임시로 4번 Index의 캐릭터 애셋을 사용한다.
...
void AABCharacter::AttackCheck()
{
	...
	float HalfHeight = FinalAttackRange * 0.5 + AttackRadius;
